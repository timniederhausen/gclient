...
class P4Dependency(Dependency):
    ...
    def CreateSCM(self, out_cb=None):
        ...
        return gclient_scm.P4Wrapper(self.url, self.root.root_dir, self.name,
                                     self.outbuf, out_cb)
  ...
  solution or DEPS entry."""
    ...
    def __init__(self, root_dir, options):
        ...
        super(GClient, self).__init__(parent=None,
                                      ...
                                      managed=True,
                                      custom_deps=None,
                                      custom_vars=options.custom_vars,
                                      custom_hooks=None,
...
class CipdDependency(Dependency):
    ...
    def __init__(self, parent, name, dep_value, cipd_root, custom_vars,
        ...
        url = urlparse.urljoin(cipd_root.service_url,
                               '%s@%s' % (package, version))
...
class OptionParser(optparse.OptionParser):
    ...
    def parse_args(self, args=None, values=None):
        ...
        if options.environment_filename:
            custom_vars.update(
                self.load_environment(options.environment_filename))
